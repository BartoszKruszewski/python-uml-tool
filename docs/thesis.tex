...
\polishtitle{Narzędzie do automatycznego generowania kodu Python na podstawie diagramów UML}
\englishtitle{TODO tytuł po angielsku}
...
\begin{itemize}
    ...
    \item Implementację backendu aplikacji webowej w oparciu o framework FastAPI, zapewniającego interfejs API do obsługi żądań generowania kodu oraz eksportu projektu.
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|l|l|l|l|l|}
        \hline
        \textbf{Narzędzie} & \textbf{Kategoria} & \textbf{Platforma} & \textbf{Licencja} & \textbf{\vtop{\hbox{\strut Obsługa}\hbox{\strut XMI}}} & \textbf{\vtop{\hbox{\strut Generowanie}\hbox{\strut kodu Python}}} \\ \hline
        \vtop{\hbox{\strut Enterprise}\hbox{\strut Architect}} & Zaawansowane & Desktop & Komercyjna & Pełna & Tak \\ \hline
        \vtop{\hbox{\strut Visual}\hbox{\strut Paradigm}} & Zaawansowane & Desktop & Subskrypcja & Pełna & Tak \\ \hline
        StarUML & Lekkie & Desktop & Komercyjna & Częściowa & Ograniczone \\ \hline
        PlantUML & Code-as-Diagram & IDE / CLI & Open Source & Brak & Brak \\ \hline
        draw.io & Edytor graficzny & Web & Darmowa & Brak & Brak \\ \hline
        ArgoUML & Open Source & Desktop & Open Source & Pełna & Częściowe \\ \hline
    \end{tabular}
...
\begin{enumerate}[resume, label=\textbf{WF-\arabic*}]
...
\begin{enumerate}[resume, label=\textbf{WF-\arabic*}]
    ...
    \item System używa type hints dla parametrów i zwracanych wartości.
\end{enumerate}
