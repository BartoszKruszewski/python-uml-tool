\documentclass[polish,lic,longabstract]{iithesis}
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|l|l|l|l|l|l|}
        ...
        \textbf{Platforma} & 
        \textbf{Licencja} & 
        \textbf{\vtop{\hbox{\strut Obsługa}\hbox{\strut XMI}}} & 
        \textbf{\vtop{\hbox{\strut Generowanie}\hbox{\strut kodu Python}}} \\ \hline
        \vtop{\hbox{\strut Enterprise}\hbox{\strut Architect}} & 
        Zaawansowane & 
        Desktop & 
        Komercyjna & 
        Pełna & 
        Tak \\ \hline
        \vtop{\hbox{\strut Visual}\hbox{\strut Paradigm}} & 
        Zaawansowane & 
        Desktop & 
        Subskrypcja & 
        Pełna & 
...
\begin{enumerate}[label=\textbf{WNF-\arabic*}]
...
\begin{enumerate}[resume, label=\textbf{WNF-\arabic*}]
...
\begin{enumerate}[label=\textbf{HU-\arabic*}]
...
Aplikacja będzie dostępna w przeglądarce internetowej pod adresem \texttt{http://localhost:8080}.
...
\begin{itemize}
    ...
    \item Użyj przycisku **Clear** i zacznij od nowa
...
\begin{thebibliography}{13}
    ...
    \bibitem{omg_uml} Object Management Group, \emph{OMG Unified Modeling Language (UML) Version 2.5.1}, formal/17-12-05, \url{https://www.omg.org/spec/UML/2.5.1/}. Dostęp: 2025-12-15.

    \bibitem{omg_xmi} Object Management Group, \emph{XML Metadata Interchange (XMI) Version 2.1.1}, formal/12-05-01, \url{https://www.omg.org/spec/XMI/2.1.1/}. Dostęp: 2025-12-15.

    \bibitem{france_mdd} France R., Rumpe B., \emph{Model-driven Development of complex Software: A Research Roadmap}, Future of Software Engineering Research, ACM, 2010. Dostęp: 2025-12-15.

    \bibitem{brambilla_mdse} Brambilla M., Cabot J., Wimmer M., \emph{Model-Driven Software Engineering in Practice}, Morgan \& Claypool Publishers, 2017.

    \bibitem{pep484} Python Software Foundation, \emph{typing -- Support for type hints}, Python 3.12 Documentation, \url{https://docs.python.org/3/library/typing.html}. Dostęp: 2025-12-15.

    \bibitem{fastapi} Tiobe Software, \emph{FastAPI Documentation: High-Performance Python Web Framework}, \url{https://fastapi.tiangolo.com/}. Dostęp: 2025-12-15.

    \bibitem{enterprise_arch} Sparx Systems, \emph{Enterprise Architect User Guide v16}, Sparx Systems Pty Ltd, \url{https://sparxsystems.com/enterprise_architect_user_guide/}. Dostęp: 2025-12-15.

    \bibitem{visual_paradigm} Visual Paradigm International, \emph{Visual Paradigm User Manual}, \url{https://www.visual-paradigm.com/support/documents/vpuserguide/}. Dostęp: 2025-12-15.

    \bibitem{staruml} Plastic Software Inc., \emph{StarUML Documentation v6.0}, \url{https://docs.staruml.io/}. Dostęp: 2025-12-15.

    \bibitem{plantuml} PlantUML Team, \emph{PlantUML Documentation}, \url{https://plantuml.com/}. Dostęp: 2025-12-15.

    \bibitem{drawio} JGraph Ltd., \emph{diagrams.net (draw.io) Technical Documentation}, \url{https://www.diagrams.net/doc/}. Dostęp: 2025-12-15.

    \bibitem{clean_arch} Martin R.C., \emph{Clean Architecture: A Craftsman's Guide to Software Structure and Design}, Pearson, 2017, \url{https://www.pearson.com/en-us/subject-catalog/p/clean-architecture-a-craftsmans-guide-to-software-structure-and-design/PGM334846.html}. Dostęp: 2025-12-15.

    \bibitem{pytest_okken} Okken B., \emph{Python Testing with pytest, Second Edition}, Pragmatic Bookshelf, 2022, \url{https://pragprog.com/titles/bopytest2/python-testing-with-pytest-second-edition/}. Dostęp: 2025-12-15.
