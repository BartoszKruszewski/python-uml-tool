...
\begin{enumerate}[label=\textbf{WF-\arabic*}, leftmargin=3.5em]
...
\begin{enumerate}[resume, label=\textbf{WF-\arabic*}, leftmargin=3.5em]
...
% Zmieniamy label na WNF i usuwamy 'resume' aby zacząć numerację od 1
\begin{enumerate}[label=\textbf{WNF-\arabic*}, leftmargin=4em]
...
\begin{enumerate}[resume, label=\textbf{WNF-\arabic*}, leftmargin=4em]
...
% Zmieniamy label na HU i startujemy od 1
\begin{enumerate}[label=\textbf{HU-\arabic*}, leftmargin=3.5em]
...
- ProjectGenerator – Testowanie procesu tworzenia struktury katalogów dla projektów o różnym stopniu złożoności: pakiety puste, struktury płaskie oraz zagnieżdżone hierarchie pakietów, z weryfikacją obecności plików i prawidłowego generowania plików klas ze skeletami kodu.
...
- Optymalizacja dla systemów szkieletowych – Badania nad adaptacją narzędzia do specjalnych dziedzin, takich jak generowanie serwisów mikro, aplikacji mobilnych czy systemów rozproszonych czystością całej pracy.
